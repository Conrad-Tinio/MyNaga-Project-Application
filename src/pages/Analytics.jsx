    ...
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="card-modern p-6 animate-fade-in" style={{ animationDelay: '0.1s' }}>
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-semibold text-gray-600">Total Searches</p>
                <p className="text-3xl font-bold text-gray-900 mt-2">
                  {analyticsData.searchFrequency.reduce((sum, item) => sum + item.searches, 0).toLocaleString()}
                </p>
              </div>
              <div className="bg-gradient-to-br from-primary-100 to-primary-200 p-4 rounded-2xl shadow-md">
          ...
          <div className="card-modern p-6 animate-fade-in" style={{ animationDelay: '0.2s' }}>
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-semibold text-gray-600">Active Facilities</p>
                <p className="text-3xl font-bold text-gray-900 mt-2">{facilities.length}</p>
              </div>
              <div className="bg-gradient-to-br from-green-100 to-green-200 p-4 rounded-2xl shadow-md">
          ...
          <div className="card-modern p-6 animate-fade-in" style={{ animationDelay: '0.3s' }}>
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-semibold text-gray-600">Avg. Searches/Day</p>
                <p className="text-3xl font-bold text-gray-900 mt-2">
                  {Math.round(analyticsData.searchFrequency.reduce((sum, item) => sum + item.searches, 0) / 7)}
                </p>
              </div>
              <div className="bg-gradient-to-br from-yellow-100 to-yellow-200 p-4 rounded-2xl shadow-md">
        ...
        <div className="card-modern p-6 mb-8 animate-slide-up">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Most Searched Resources</h2>
        ...
        {/* Demand by Hour */}
        <div className="card-modern p-6 mb-8 animate-slide-up">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Demand Patterns by Hour</h2>
        ...
        <div className="card-modern p-6 mb-8 animate-slide-up">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Facility Utilization</h2>
        ...
        {/* Privacy Notice */}
        <div className="glass bg-blue-50/80 border border-blue-200/50 rounded-xl p-5 backdrop-blur-sm animate-fade-in">
          <div className="flex items-start space-x-3">
            <AlertCircle className="w-5 h-5 text-blue-600 mt-0.5 flex-shrink-0" />
            <div>
              <h3 className="text-sm font-bold text-blue-900 mb-1">Privacy Notice</h3>
